...
export const ZH_CN = {
  ...
  PICBED_GOFLET_JWT_ALGORITHM: '设定JWT算法',
  PICBED_GOFLET_JWT_SECRET: '设定JWT密钥',
  PICBED_GOFLET_JWT_ISSUER: '设定JWT签发者',
  PICBED_GOFLET_ENDPOINT: '设定上传地址',
  PICBED_GOFLET_MESSAGE_ENDPOINT: '例如: https://goflet.com',
  PICBED_GOFLET_PATH: '设定存储路径',
  PICBED_GOFLET_MESSAGE_PATH: '例如: test/',
  PICBED_GOFLET_OPTIONS: '设定网址后缀',
  PICBED_GOFLET_MESSAGE_OPTIONS: '例如: ?h=100&w=100',
