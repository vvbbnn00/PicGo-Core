...
export const ZH_TW: ILocales = {
  ...
  PICBED_GOFLET_JWT_ALGORITHM: '設定JWT算法',
  PICBED_GOFLET_JWT_SECRET: '設定JWT密鑰',
  PICBED_GOFLET_JWT_ISSUER: '設定JWT發行者',
  PICBED_GOFLET_ENDPOINT: '設定上傳地址',
  PICBED_GOFLET_MESSAGE_ENDPOINT: '例如: https://goflet.com',
  PICBED_GOFLET_PATH: '設定儲存路徑',
  PICBED_GOFLET_MESSAGE_PATH: '例如: test/',
  PICBED_GOFLET_OPTIONS: '設定網址後綴',
